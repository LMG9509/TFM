...
ggsave ("curvas_puntos.png", plot = curvas_seg,path="./figuras", width = 20, height = 10, dpi = 300)
...
div_hr_rseg$Escenario<-"Alto numero de lecturas"
...
div_lr_rseg$Escenario<-"Bajo numero de lecturas"
